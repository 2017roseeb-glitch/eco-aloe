...
const catalogProducts = [
  ...
  ["에코 알로에 헤어 컨디셔너", "760ml", "13,000원", "assets/cat-aloe-conditioner-pack.png", "aloeConditioner"],
  ["에코 알로에 헤어 트리트먼트", "760ml", "13,000원", "assets/cat-treatment-pack.png", "treatment"],
  ["에코 알로에 헤어젤", "530ml", "12,000원", "assets/cat-hair-gel-pack.png", "hairGel"],
  ["에코 알로에 헤어 멀티에센스", "530ml", "15,000원", "assets/cat-multi-essence-pack.png", "multiEssence"],
  ["에코 알로에 헤어 스프레이", "300ml", "7,000원", "assets/cat-hair-spray-pack.png", "hairSpray"],
  ["에코 알로에 헤어 코팅 에센스", "200ml", "16,000원", "assets/cat-coating-essence-pack.png", "coatingEssence"],
  ["에코 알로에 초강력 헤어미스트", "250ml", "9,000원", "assets/hair-mist-product.png", "strongMist"],
  ["에코 알로에 아르간 헤어오일", "200ml", "20,000원", "assets/aloe-argan-hair-oil.png", "arganOil"],
  ["에코 헤어 칼라크림 새치용", "60ml", "11,000원", "assets/hair-color-gray-cover.png", "hairColor"],
  ["에코 알로에 헤어칼라 크림 멋내기용", "60ml", "11,000원", "assets/hair-color-fashion.png", "aloeHairColor"],
  ["에코 알로에 헤어 컬링 에센스", "150ml", "9,000원", "assets/cat-silk-curling-essence.png", "curlingEssence"],
  ["에코 알로에 바디 클렌저", "750ml", "15,000원", "assets/cat-body-cleanser-pack.png", "bodyCleanser"],
  ["에코 알로에 바디 에센스", "500ml", "15,000원", "assets/cat-body-essence-pack.png", "bodyEssence"],
  ["에코 로즈 바디 클렌저", "760ml", "15,000원", "assets/eco-rose-body-cleanser.png", "roseCleanser"],
  ["에코 로즈 바디 에센스", "530ml", "15,000원", "assets/eco-rose-body-essence.png", "roseEssence"],
