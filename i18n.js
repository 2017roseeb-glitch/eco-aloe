  ...
  ja: {
    store: {
      ...
      productNames: {
        ...
        limeMintSet: "ROSEE エコ ライムミント ボディ2点セット",
  ...
  "zh-CN": {
    store: {
      ...
      productNames: {
        ...
        roseEssence: "ECO玫瑰身体乳", limeMintSet: "ROSEE ECO青柠薄荷身体护理两件套",
        bodySet: "ECO芦荟保湿洁面泡沫",
      },
    },
    brand: {
  ...
  vi: {
    store: {
      ...
      productNames: {
        ...
        roseEssence: "Tinh chất dưỡng thể Eco Rose", limeMintSet: "Bộ đôi dưỡng thể Rosee Eco Chanh Bạc Hà",
  ...
  th: {
    store: {
      ...
      productNames: {
        ...
        roseEssence: "เอสเซนส์บำรุงผิวกาย Eco Rose", limeMintSet: "ชุดดูแลผิวกาย Rosee Eco Lime Mint 2 ชิ้น",
  ...
  ru: {
    store: {
      ...
      productNames: {
        ...
        roseEssence: "Эссенция для тела Eco Rose", limeMintSet: "Набор для тела Rosee Eco Lime Mint, 2 предмета",
  ...
  uz: {
    store: {
      ...
      productNames: {
        ...
        roseEssence: "Eco Rose tana essensiyasi", limeMintSet: "Rosee Eco Lime Mint tana parvarishi 2 talik to‘plami",
